...
os.system('espeak  " WELLCOME   TO THE   HASAN COMMAND"')
...
def meyexudi():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      os.system('espeak   " Assalamualaikum,   I,   Am,    JIBON,   AHMED,    Please,   Send,   Your,   Key,"')
      print(" \x1b[0m[] YOUR KEY : "+id)
      input(' \033[1;30m[] IF U WANT TO BUY THEN PRESS ENTER ')
      tks = ('Hi%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('espeak    am start https://wa.me/?text='+tks),approval()      
      time.sleep(1)
      meyexudi()
  except:
    sys.exit()
...
os.system('espeak   " TOOL UPDATE SUCCESSFUL"')
...
def C1():
    ...
    #os.system('xdg-open fb://group/1885398221816745?ref=share&mibextid=NSMWBT')
    print(logo)
    os.system('espeak   " PLEAS TYP YOUR NAME"')
    ...
    os.system('espeak   " PLEACE TYP YOUR SIM CODE"')
    print('==============================================')
    ...
    os.system('clear')
    print(logo)
    os.system('espeak   " TYP YOUR CRACKED LIMITE"')
